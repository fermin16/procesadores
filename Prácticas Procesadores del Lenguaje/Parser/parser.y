...
desc_algoritmo: 
    BIS_ALGORITMO BIS_IDENTIFICADOR BIS_PUNTO_COMA cabecera_alg bloque_alg BIS_FALGORITMO BIS_PUNTO_COMA {printf("desc_algoritmo 0\n");}
;

cabecera_alg:
    decl_globales decl_a_f decl_ent_sal BIS_COMENTARIO {printf("cabecera_alg 0\n");}
    | decl_globales decl_a_f decl_ent_sal {printf("cabecera_alg 1\n");}
;


bloque_alg:
    bloque BIS_COMENTARIO {printf("bloque_alg 0\n");} 
    | bloque {printf("bloque_alg 1\n");} 
;
